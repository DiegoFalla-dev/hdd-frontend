...
const Confirmacion: React.FC = () => {
  ...
  const day = searchParams.get('day') || selection?.selectedDay;
  const time = searchParams.get('time') || selection?.selectedTime;
  const format = searchParams.get('format') || selection?.selectedFormat;

  const pelicula = selection?.pelicula ?? null;
      ...
      <div className="flex">
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm mb-8" style={{ color: 'var(--cineplus-gray)' }}>Estás a unos pocos pasos de tener una gran experiencia.</p>
          </div>
        </div>
        ...
        <div className="w-80 p-6 border-l" style={{ borderColor: 'var(--cineplus-gray-dark)', background: 'var(--cineplus-gray-dark)' }}>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-3">
              <img src={pelicula.imagenCard || '/placeholder.jpg'} alt={pelicula.titulo} className="w-12 h-16 object-cover rounded" />
              <div>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: 'var(--cineplus-gray)' }}>{formatDate(day || '')} - {time}</p>
              </div>
            </div>
          </div>
